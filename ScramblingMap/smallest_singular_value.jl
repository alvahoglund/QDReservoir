...
function get_ham(grids)
    ϵ_func_main, ϵ_func_res, ϵb_func, u_intra_func, t_func, t_so_func, u_inter_func = set_parameters()
    return get_ham(grids, ϵ_func_main, ϵ_func_res, ϵb_func,
        u_intra_func, t_func, t_so_func, u_inter_func)
end
...
function avg_smallest_sv(nbr_dots_res_list, t, nbr_samples)
    nbr_dots_main = 2
    ...
    for nbr_dots_res in nbr_dots_res_list
        ...
        randomized_hams = [get_ham(grid) for _ in 1:nbr_samples]
...
function set_parameters()
    ...
    t_so_func() = 0.1 * rand()
    u_inter_func() = rand()
    return ϵ_func_main, ϵ_func_res, ϵb_func, u_intra_func, t_func, t_so_func, u_inter_func
end
...
avg_smallest_sv_dict_1 = avg_smallest_sv(nbr_dots_res_list, t, nbr_samples)
...
avg_smallest_sv_dict_2 = avg_smallest_sv(nbr_dots_res_list, t, nbr_samples)
...
avg_smallest_sv_dict_3 = avg_smallest_sv(nbr_dots_res_list, t, nbr_samples)
...
avg_smallest_sv_dict_4 = avg_smallest_sv(nbr_dots_res_list, t, nbr_samples)
